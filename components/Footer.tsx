      ...
      <div className="container mx-auto px-4 py-8 md:py-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 mb-4 leading-relaxed">{siteData.photographer.tagline}</p>
            ...
            <div className="flex gap-3">
              ...
              <a href="#" aria-label="Twitter" className="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-all transform hover:scale-110">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-all transform hover:scale-110">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/photography/travel" className="hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <span className="group-hover:translate-x-1 transition-transform">✈️</span>
                  <span>Travel Photography</span>
                </Link>
              </li>
              <li>
                <Link href="/photography/sports" className="hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <span className="group-hover:translate-x-1 transition-transform">⚽</span>
                  <span>Sports Photography</span>
                </Link>
              </li>
              <li>
                <Link href="/photography/party" className="hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <span className="group-hover:translate-x-1 transition-transform">🎉</span>
                  <span>Event Photography</span>
                </Link>
              </li>
              <li>
                <Link href="/videography" className="hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <span className="group-hover:translate-x-1 transition-transform">🎬</span>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/gallery" className="hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link href="/about" className="hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link href="/contact" className="hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${siteData.photographer.location.phone}`} className="hover:text-primary-400 transition-colors">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`mailto:${siteData.photographer.location.email}`} className="hover:text-primary-400 transition-colors break-all">
                  {siteData.photographer.location.email}
                </a>
              </li>
            </ul>
            <div className="mt-4 p-3 bg-gray-800 rounded-lg border border-gray-700">
              <p className="text-xs text-gray-400 mb-1">Service Areas:</p>
              <p className="text-xs text-primary-300">{siteData.photographer.location.serviceAreas.slice(0, 3).join(', ')}</p>
            </div>
          </div>
        </div>

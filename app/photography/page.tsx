    ...
    <article className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {categories.map((category) => (
            <Link 
              ...
              className="group block bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-xl hover:border-primary-100 transition-all duration-300 transform hover:-translate-y-1"
            >
              <div className="text-4xl mb-6 bg-primary-50 w-16 h-16 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                {category.icon}
              </div>
        ...
        <section className="mt-20 text-center">
          <div className="bg-primary-900 text-white rounded-3xl p-12 relative overflow-hidden">
             {/* Decorative circles */}
